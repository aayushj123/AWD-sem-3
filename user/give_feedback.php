...
{
$query="insert into feedback values('$user','$faculty','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13','$quest14')";
...
<form method="post">
<fieldset>
<h1 style="margin-left:33%; color:rgb(10,10,100);"><u> Student's FeedBack Form</u></h1><br>
